...
<div className="first-section">
      ...
      {menuOpen && 
        <ul className="hamburgerNav-links">
          <li><a className="nav-link" href='#about' onClick = {toggleMenu}>About</a></li>
          <li><a className="nav-link" href='#experience' onClick = {toggleMenu}>Experience</a></li>
          <li><a className="nav-link" href='#projects' onClick = {toggleMenu}>Projects</a></li>
          <li><a className="nav-link" href='#contact' onClick = {toggleMenu}>Contact</a></li>
...
<div className='bio'>
        <p >
        Hello and welcome to my website. I’m Ben Eskro, a recent college graduate with a passion for solving real
